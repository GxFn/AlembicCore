...
import { evaluateProjectAnalysisIncrementalPlan } from '../src/workflows/capabilities/project-intelligence/ProjectIntelligenceIncrementalPlanner.js';
...
vi.mock('../src/workflows/capabilities/project-intelligence/FileDiffPlanner.js', () => ({
